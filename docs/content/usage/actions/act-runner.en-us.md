...
Starting with Gitea 1.21, you can change labels by modifying `runner.labels` in the runner configuration file (if you don't have a configuration file, please refer to [configuration tutorials](#configuration)).
